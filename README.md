...
- `workspace-companion` — Markdown notes, agent Kanban, custom review states, and manual diff review plans.
...
- `dev-ports` — workspace-scoped listening ports, safe `SIGTERM`, and private Tailscale Serve controls.
